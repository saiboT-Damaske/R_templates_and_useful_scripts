...
a18 <- import("C:/Users/Tobi/Desktop/SoSe 20/Praktische datenanalyse mit R - Deskriptive & Induktive Statistik (f�r Fortgeschrittene)/Allbus2018-20200420/allbus2018.rds")
str(a18)
glimpse(a18)
